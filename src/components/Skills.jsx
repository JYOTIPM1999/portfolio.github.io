...
export const Skills = () => {
  const [{ all, front, back }, showSkills] = useState({
    all: true,
    front: false,
  });
    ...
    >
      ...
      <div id="skillButtonsCont">
        <button
          class="button-75"
          role="button"
          onClick={() => showSkills({ all: true, front: false })}
          style={{
            backgroundImage: all
        ...
        <button
          class="button-75"
          role="button"
          onClick={() => showSkills({ all: false, front: true })}
          style={{
        ...
        <button
          class="button-75"
          role="button"
          onClick={() => showSkills({ all: false, front: false })}
          style={{
            backgroundImage:
              !all && !front
                ? "linear-gradient(135deg, #f34079 40%, #fc894d)"
