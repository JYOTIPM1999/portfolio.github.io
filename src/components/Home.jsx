  ...
  return (
    <div id="home" style={{ "--bglight": light ? "#edf2f8" : "#0a192f" }}>
      ...
      >
        ...
        <p>
          An ambitious, self motivated and result driven full stack web
          developer dedicated to building and optimizing user-focused websites
          and applications. Able to work under pressure with minimal
          supervision. A quick learner who can absorb new ideas and can
          communicate them clearly and effectively.
        </p>
        <div className="homeCont">
          <a
            href="/assets/Jyoti.pdf"
            style={{ textDecoration: "none" }}
            download="Jyoti_Prakash_Mohapatra_Resume"
          >
            <button>
              Resume{" "}
              <i>
          ...
          >
            ...
            <div>
              <a href="mailto:jyotipm1999@gmail.com">
